...
import bg from "../../../public/Properties/035.jpg";
            ...
            <div className="block rounded-lg py-2 md:py-4 px-4 md:px-6 bg-[#f8f8f8] opacity-80 backdrop-blur-[30px]">
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 ">
                ...
                <div className="mb-12 lg:mb-0 text-center mx-auto">
                  ...
                  <h6 className="font-medium">Lahore, DHA</h6>
                </div>
                <div className="mb-6 md:mb-0 text-center mx-auto">
                  ...
                  <h6 className="font-medium"> 042-64820374</h6>
                </div>
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="md:mb-12 lg:mb-0">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3402.9149949287234!2d74.35296727448966!3d31.471524449555652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39190680e8f2d445%3A0x32ba63a1571efb2a!2sPackages%20Mall!5e0!3m2!1sen!2s!4v1720302105316!5m2!1sen!2s"
                  // width="600"
                  // height="450"
